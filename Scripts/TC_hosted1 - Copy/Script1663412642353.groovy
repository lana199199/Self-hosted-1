...
WebUI.click(findTestObject('Object Repository/Page_katalon - Tm trn Google/h3_Katalon  Simplify Web, API, Mobile, Desk_d51335'))

WebUI.click(findTestObject('Object Repository/Page_Katalon  Simplify Web, API, Mobile, De_2f1b85/span_Get Started'))

WebUI.navigateToUrl('https://katalon.com/sign-up?ref=home_banner_signup_btn')
